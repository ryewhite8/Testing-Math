...
public class MathTest {
    ...
    public void testReciprocal(double base, double exponent) {
        ...
        double Math.pow(base,-exponent) = 1/ double Math.pow(base, exponent);
    }
    ...
    public void testMultiplying(double base, double a, double b) {
        ...
        double Math.pow(base,a) * double Math.pow(base,b) = double Math.pow(base,a+b);
    }
    ...
    public void testNestedPowers(double base, double a, double b) {
        double Math.pow((double Math.pow(base,a),b) = double Math.pow(base,a)*b;
    }
